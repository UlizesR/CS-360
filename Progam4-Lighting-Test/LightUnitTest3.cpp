...
int main()
{
    ...
    Rgb ambientIntensity(0.2, 0.2, 0.2);
    Rgb ambientMaterial(0, 0.5, 0.8);

    Tuple lightPoint(10, 50, 3, 1);
    Rgb diffuseIntensity(0.3, 0.5, 0.5);
    Rgb diffuseMaterial(0.6, 0.3, 0.4);

    // Camera or eye point used in specular reflection.
    Tuple cameraPoint(-10, 10, 0, 1);

    Rgb specularIntensity(0.5, 0.5, 0.5);
    Rgb specularMaterial(0.5, 0.3, 0.12);
    int specularExponent = 2;

    Tuple objectPoint(10, 7, 4, 1);
